...
With that being said, if you are reading this and are maintaining your own Docusaurus website (I know VRChat uses it for their Creators Docs), I highly recommend you read the [full blog post here <FAIcon icon="fa-solid fa-square-arrow-up-right"/>](https://docusaurus.io/blog/releases/3.10) on Docusaurus v3.10 release, which details how to prepare your website for Docusaurus v4.0.
